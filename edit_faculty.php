...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (!$result) {
        $errorMessage = "Error retrieving data: " . $connection->error;
    } else {
    ...
    if(empty($name) || empty($email) || empty($phone) || empty($address) || empty($subject)) {
        $errorMessage = "All fields are required! Please fill in all the fields.";
    } else {
        $sql = "UPDATE teacher " .
               "SET name='$name', email='$email', phone='$phone', address='$address', subject='$subject' " .
               "WHERE id=$id";
...
<body>
    <div class="container my-5">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <label class="col-sm col-form-label">Phone</label>
                <div class="col-sm-6">
